...
int main()
    ...
    system("cls");
    printf("\n ------------------  Welcome %s to C Program Quiz Game --------------------------",gambler);
    ...
    if (toupper(getch())=='Y')
     ...
     system("cls");
     count=0;
     for(quesChangerLoopInput=1;quesChangerLoopInput<=3;quesChangerLoopInput++)
     {
    system("cls");
     quesChangerToInGame=quesChangerLoopInput;


     switch(quesChangerToInGame)
		{
		case 1:
        ...
        case 4:
		printf("\n\n\nWho was awarded the youngest gambler award in Fifa World Cup 2006?");
	...
	goto homeScreen;
     ...
     test:
     system("cls");
     printf("\n\n\t*** CONGRATULATION %s you are eligible to play the Game ***",gambler);
     printf("\n\n\n\n\t!Press any key to Start the Game!");
     if(toupper(getch())=='p')
		{goto game;}
game:
     trueQuesCount=0;
     for(quesChangerLoopInput=1;quesChangerLoopInput<=10;quesChangerLoopInput++)
     {system("cls");
     gameQuesChanger=quesChangerLoopInput;

     switch(gameQuesChanger)
		{
		case 1:
		printf("\n\nWhat is the National Game of England?");
		printf("\n\nA.Football\t\tB.Basketball\n\nC.Cricket\t\tD.Baseball");
		if (toupper(getch())=='C')
			{printf("\n\nCorrect!!!");trueQuesCount++;getch();
			 break;getch();}
		else
		...
		printf("\n\nA.Coulomb\t\tB.Watt\n\nC.Power\t\tD.Units");
		if (toupper(getch())=='B')
			{printf("\n\nCorrect!!!");trueQuesCount++;getch(); break;}
		else
		       {
	...
	score:
    system("cls");
	score=(float)trueQuesCount*100000;
